...
from scripts.utils import Projectile, Sun, Particle, ParticleBurst
from scripts.plants import Peashooter, Sunflower, Walnut
...
class Game:
    ...
    def __init__(self):
        ...
        self.assets = {
            ...
            "zombies":{
                "normal":pygame.image.load("data/images/zombies/normal.png")
            },
            "projectiles":{
